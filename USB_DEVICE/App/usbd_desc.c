...
#define USBD_PID     22657
#define USBD_PRODUCT_STRING     "STM32 Composite HID VCP"
#define USBD_CONFIGURATION_STRING     "Custom Composite Config"
#define USBD_INTERFACE_STRING     "Custom Composite Interface"
